...
let {SignUpValidator,LoginValidator,validate, checkPassword, checkChangePassword} = require('../utils/validator')
...
router.post('/change_password',checkChangePassword, check_authentication,
